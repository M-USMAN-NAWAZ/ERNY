...
namespace NatSuite.Examples
{
    ...
    public class updaecamera : MonoBehaviour
{
    string ssd;
    ...
    public GameObject iamgeton,bg;
    public Texture tt;
    public GameObject panel, updateecent;
  ...
  */
                ...
                NativeCamera.Permission permission = NativeCamera.TakePicture((path) =>
            {
                ...
                if (path != null)
                {
                  ...
                  //  iamgeton.GetComponent<AspectRatioFitter>().aspectRatio = aspctratio;
                    ...
                    updatenativegallery.updateimagevalue = 0;
                    ImageCropper.Instance.Show(ss, (bool result, Texture originalImage, Texture2D croppedImage) =>
                    {
                        ...
                        if (result)
                        {
                         //   iamgeton.GetComponent<AspectRatioFitter>().aspectRatio = 1;
                            ...
                            updataeven.eventimgetexture = (Texture2D)iamgeton.GetComponent<RawImage>().texture;
                            iamgeton.GetComponent<RawImage>().enabled = true;
                        ...
                        else
                        {
                            panel.SetActive(false);
                            updataeven.instance.closecamera();
                            iamgeton.GetComponent<RawImage>().enabled = false;
                            iamgeton.GetComponent<RawImage>().enabled = false;
                        }
                  ...
                  croppedImageResizePolicy: (ref int width, ref int height) =>
                  {
                    ...
                    updataeven.instance.imagepath = ssd;
    ...
    private IEnumerator TakeScreenshotAndSave()
    {
        ...
        updataeven.eventimgetexture = ss;
            bg.SetActive(true);
        iamgeton.SetActive(true);
            float width = Screen.width;
            float height = Screen.height;
    ...
    public void good()
    {
                ...
                updataeven.instance.sendcameratext();
