...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour, IEndDragHandler
    {
        #region Public
        ...
        void Awake()
        {
            /*  GameObject go;
              ...
              //     DestroyImmediate(_scrollRect.content.gameObject);
               ...
               {   //       go.AddComponent<VerticalLayoutGroup>();
                   ...
                   _container = cont;// go.GetComponent<RectTransform>();
            ...
            //if (_scrollRect == null)
            //{
            //    Debug.LogError("ScrollRect not found on this GameObject!");
            //    return;
            //}
