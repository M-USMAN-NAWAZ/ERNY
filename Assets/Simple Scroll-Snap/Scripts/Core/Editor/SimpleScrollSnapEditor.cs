...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnapEditor : SSSCopyrightEditor
    {
        ...
        {
            EditorGUILayout.ObjectField(finishButton, typeof(Button), new GUIContent("Finish Button", "(Optional) Button shown on the last panel while pagination is hidden."));
        }
