...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private void Setup()
        {
            ...
            UpdateLastPanelControls(startingPanel);
        }
        ...
        public void GoToPanel(int panelNumber)
        {
            ...
            UpdateLastPanelControls(panelNumber);
        }

        private void UpdateLastPanelControls(int panelNumber)
        {
            bool isLastPanel = panelNumber == NumberOfPanels - 1;

            if (pagination != null)
            {
                pagination.gameObject.SetActive(!isLastPanel);
            }

            if (finishButton != null)
            {
                finishButton.gameObject.SetActive(isLastPanel);
            }
        }
