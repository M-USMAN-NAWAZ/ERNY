...
public class newnativegallery : MonoBehaviour
{
    public GameObject panel;

    public static int imagevalue;
    public Texture gg;
    ...
    public void approve()
    {
        ...
        //   rawimage.GetComponent<RawImage>().texture.height, TextureFormat.RGB24, false, false); ;
        eventgetter.instance.sendconverttext();
    ...
    public void PickImage(int maxSize)
    {
        NativeGallery.Permission permission = NativeGallery.GetImageFromGallery((path) =>
        {
            ...
            if (path != null)
            {
                ...
                eventgetter.instance.imagepath = path;
                if (texture == null)
                {
                ...
                {
                    float ratioo = texture.width / texture.height;

                    //rawimage.GetComponent<AspectRatioFitter>().aspectMode = AspectRatioFitter.AspectMode.FitInParent;
                    //rawimage.GetComponent<AspectRatioFitter>().aspectRatio = ratioo;
                ...
                else
                {
                    ...
                    Debug.Log("aspect: " + ratioo);
                    //rawimage.GetComponent<AspectRatioFitter>().aspectMode = AspectRatioFitter.AspectMode.HeightControlsWidth;
                    //	rawimage.GetComponent<AspectRatioFitter>().aspectRatio = aspctratio;
                    //		Debug.Log("aspect: " + aspctratio);
                    //	rawimage.GetComponent<AspectRatioFitter>().aspectRatio = aspctratio;
                    //	rawimage.GetComponent<RawImage>().texture = texture;
                ...
                ImageCropper.Instance.Show(texture, (bool result, Texture originalImage, Texture2D croppedImage) =>
                {
                    ...
                    if (result)
                    {
                        ...
                        duplicateTexture(croppedImage);
                        rawimage.GetComponent<RawImage>().enabled = true;
                        eventgetter.profiletexture = (Texture2D)rawimage.GetComponent<RawImage>().texture;
                        eventgetter.eventimgetexture = (Texture2D)rawimage.GetComponent<RawImage>().texture;
                        approve();
    ...
    Texture2D duplicateTexture(Texture2D source)
    {
        ...
        rawimage.GetComponent<RawImage>().texture = readableText;
