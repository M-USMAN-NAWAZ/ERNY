...
{
    [CustomEditor(typeof(WindowsRecorderSettings))]
    public class WindowsRecorderSettingsEditor : NSRPackageEditor
    {
        private WindowsRecorderSettings _target;
        ...
        {
            if (target) _target = (WindowsRecorderSettings)target;
        ...
        {
            BoxLogo(null, " <b><color=#ffffff>Windows Recorder Settings</color></b>");
