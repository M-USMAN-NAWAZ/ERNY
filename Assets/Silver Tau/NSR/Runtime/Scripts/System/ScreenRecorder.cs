...
namespace SilverTau.NSR
{
    ...
    /// </summary>
    [Serializable]
    public enum NativeScreenRecorderStatus
    {
        None = 0,
        Init = 1,
        Recording = 2,
    ...
    public class ScreenRecorder : MonoBehaviour
    {
        ...
        private void Start()
        {
            ChangeRecorderStatus(NativeScreenRecorderStatus.None);
        ...
        /// </summary>
        public static NativeScreenRecorderStatus CurrentRecorderStatus { get; private set; }
        ...
        /// </summary>
        public static UnityAction<NativeScreenRecorderStatus> onRecorderStatus;
        ...
        private static void ChangeRecorderStatus(NativeScreenRecorderStatus recStatus)
        {
        ...
        public static void Initialize()
        {
            ...
            ChangeRecorderStatus(NativeScreenRecorderStatus.Init);
            NSRInit = true;
#else
            NSRInit = false;
#endif
        ...
        {
            ChangeRecorderStatus(NativeScreenRecorderStatus.Recording);
        ...
        {
            ChangeRecorderStatus(NativeScreenRecorderStatus.Stopped);
            recorderStop?.Invoke();
        }
