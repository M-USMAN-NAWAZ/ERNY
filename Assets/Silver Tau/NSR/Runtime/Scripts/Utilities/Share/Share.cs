...
namespace SilverTau.NSR.Utilities
{
    public static class Share
    {
        ...
        /// <summary>
        /// Sets custom title for Android share chooser (default is "NSR - Share").
        /// </summary>
        public static void ShareAndroidSetTitle(string title)
        {
            if(string.IsNullOrEmpty(title)) return;
            
#if !UNITY_EDITOR && PLATFORM_ANDROID
            SetAndroidShareTitle(title);
#endif
        }
        ...
        public static void SetAndroidShareTitle(string title)
        {
            if (Application.platform == RuntimePlatform.Android) {
                AndroidJavaClass unityPlayerClass = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
                AndroidJavaObject unityActivity = unityPlayerClass.GetStatic<AndroidJavaObject>("currentActivity");      
                ...
                parameters[0] = title;
                share.Call("setShareChooserTitle", parameters);
            }
        }
#endif
