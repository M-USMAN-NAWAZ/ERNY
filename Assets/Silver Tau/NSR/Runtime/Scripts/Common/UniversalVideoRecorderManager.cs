    ...
    public class UniversalVideoRecorderManager : MonoBehaviour
    {
        ...
        private void SaveVideo()
        {
            ...
            try
            {
                ...
                var format = Path.GetExtension(outputPath);
        ...
        {
            var universalVideoRecorder = UniversalVideoRecorder.Instance;
            if(universalVideoRecorder == null) return null;

            var recorder = universalVideoRecorder.NSRVideoRecorder;
            if(recorder == null) return null;
            
            return recorder.VideoOutputPath;
        }
    }
}
