...
namespace SilverTau.NSR.Samples
{
    ...
    public class TextVideoTimer : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            universalVideoRecorder.NSRVideoRecorder.onStartCapture += OnStartCapture;
            universalVideoRecorder.NSRVideoRecorder.onPauseCapture += OnPauseCapture;
            universalVideoRecorder.NSRVideoRecorder.onResumeCapture += OnResumeCapture;
            universalVideoRecorder.NSRVideoRecorder.onStopCapture += OnStopCapture;
        }
